...
departmentRouter.post('/', async (req: Request, res: Response): Promise<any> => {
...
departmentRouter.get('/', async (req: Request, res: Response): Promise<any> => {
  try {
...
departmentRouter.get('/:id', async (req: Request, res: Response): Promise<any> => {
  const { id } = req.params;
...
departmentRouter.put('/:id', async (req: Request, res: Response): Promise<any> => {
  const { id } = req.params;
  const { name, collegeId } = req.body;
...
departmentRouter.delete('/:id', async (req: Request, res: Response): Promise<any> => {
  const { id } = req.params;
